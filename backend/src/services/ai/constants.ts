...
export const URGENCY_SIGNALS: Array<[string, number]> = [
  ...
  // Trainer / fitness / exercise harm
  ['trainer',            0.90], ['instructor',         0.90],
  ['coach',              0.85], ['exercise',           0.75],
  ['workout',            0.75], ['worsened',           0.90],
  ['worsened my condition', 0.95], ['worsened my medical', 0.95],
  ['medical condition',  0.85], ['made me do',         0.80],
  ['forced me',          0.80], ['didn\'t guide',      0.90],
  ['improper guidance',  0.90], ['wrong guidance',     0.90],
  ['no guidance',        0.85], ['not guided',         0.85],
  ['physical therapy',   0.85], ['physiotherapy',      0.85],
  ['aggravated',         0.90], ['aggravated my',      0.95],
...
export const KEYWORD_CATEGORY_MAP: Array<[string, string, number]> = [
  ...
  // Trainer / fitness / exercise harm → Product (service/health harm)
  ['trainer',                'Product',   0.85],
  ['instructor',             'Product',   0.85],
  ['coach',                  'Product',   0.80],
  ['exercise',               'Product',   0.70],
  ['workout',                'Product',   0.70],
  ['worsened',               'Product',   0.85],
  ['worsened my condition',  'Product',   0.95],
  ['worsened my medical',    'Product',   0.95],
  ['medical condition',      'Product',   0.80],
  ['aggravated',             'Product',   0.85],
  ['aggravated my',          'Product',   0.90],
  ['didn\'t guide',          'Product',   0.85],
  ['improper guidance',      'Product',   0.85],
  ['not guided',             'Product',   0.80],
  ['physical therapy',       'Product',   0.80],
  ['physiotherapy',          'Product',   0.80],
  // Injury / negligence → Product
  ['injured',                'Product',   1.00],
  ['injury',                 'Product',   1.00],
  ['negligence',             'Product',   0.90],
  ['harmed',                 'Product',   0.90],
  ['physical harm',          'Product',   0.95],
  ['got hurt',               'Product',   0.90],
  ['got injured',            'Product',   0.95],
  // Packaging
